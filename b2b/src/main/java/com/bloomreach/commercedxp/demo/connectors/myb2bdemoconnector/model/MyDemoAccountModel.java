...
import com.bloomreach.commercedxp.api.v2.connector.model.AbstractAccountModel;
import com.bloomreach.commercedxp.api.v2.connector.model.AddressGroupModel;

public class MyDemoAccountModel extends AbstractAccountModel {

    private final String id;
    private String name;

    public MyDemoAccountModel(final String id, final String name) {
        this.id = id;
        this.name = name;
    }
