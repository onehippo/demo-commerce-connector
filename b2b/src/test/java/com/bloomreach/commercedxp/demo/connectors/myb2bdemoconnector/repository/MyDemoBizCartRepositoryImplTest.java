...
public class MyDemoBizCartRepositoryImplTest extends AbstractMyDemoBizRepositoryTest {

    private BizCartRepository cartRepository;

    @Before
    public void setUp() throws Exception {
        cartRepository = new MyDemoBizCartRepositoryImpl();
